...
Ces fonctions vous permettent d'adapter votre service {{site.data.keyword.composeForRethinkDB_full}} de sorte qu'il réponde mieux à vos besoins et exigences.
...
![Panneau Version](./images/rethink-version-show.png "Panneau Version")
...
![Adresses IP mises en liste blanche](./images/rethink-whitelist-show.png "Zones d'une liste blanche.")
