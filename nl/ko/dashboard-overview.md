...
**관리** 탭의 링크는 _RethinkDB 관리 콘솔_을 엽니다. 로그인 정보는 'rethinkdb://' 다음에 오고 '@' 앞에 있는 **HTTPS** 연결 문자열에 있습니다.
...
{{site.data.keyword.cloud_notm}} Compose API를 통해 {{site.data.keyword.composeForRethinkDB}} 서비스를 관리할 수 있습니다.
