...
這些特性可讓您調整 {{site.data.keyword.composeForRethinkDB_full}} 服務以更符合您的需求。
...
![「版本」畫面](./images/rethink-version-show.png "「版本」畫面")
...
2. 在_部署詳細資料_ 畫面中，按一下**調整資源**。即會開啟「調整資源」頁面。
    ...
    ![「調整資源」頁面](./images/rethink-scale-show.png "「調整資源」頁面")

3. 調整調節器來提高或降低配置給 {{site.data.keyword.composeForRethinkDB}} 服務的儲存空間。將調節器移至左邊以減少儲存空間數量，或將它移至右邊以增加儲存空間。
...
![更新 RethinkDB 密碼](./images/rethink-update-password.png "自動密碼產生器")
...
![將 IP 列入白名單](./images/rethink-whitelist-show.png "白名單欄位。")
