...
More useful database related information is in the [Compose Articles](https://www.compose.com/articles/) blog and our [curated collection of RethinkDB-related topics](https://www.compose.com/articles/curated-collection-rethinkdb/) for more how-to's and information on RethinkDB on Compose.
...
Once you have a {{site.data.keyword.composeEnterprise}} cluster, selecting the {{site.data.keyword.composeForRethinkDB}} service with the Enterprise plan will provision the service onto your dedicated cluster. 
