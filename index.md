...
## Connecting an {{site.data.keyword.cloud_notm}} application to Compose for RethinkDB
...
## Connecting to Compose for RethinkDB from outside {{site.data.keyword.cloud_notm}}
